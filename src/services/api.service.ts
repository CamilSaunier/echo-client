...
export const api = axios.create({
  baseURL: API_URL, // Toutes nos requêtes commenceront par http://localhost:8000/api
  withCredentials: true, // Équivalent de credentials: "include" : force le navigateur à envoyer/recevoir les cookies HttpOnly
  headers: {
